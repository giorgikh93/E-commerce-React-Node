    ...
    const pictures = data.map((item, index) => {
        return <tr key={index}>
            ...
            <td>
                {
                    item.image !== '' ?
                        <img src={`${SERVER_PATH}pictures/${item.image}`} style={{ width: '100px', height: '100px' }} alt='img' />
                        : ''
                }
            </td>
            ...
            <div className='addProduct'>
                {props.isClicked &&
                    <form >
                        ...
                        />
                        <span
                            ref={warningRef} className='none' style={{ color: 'red' }}>ID must be unique!</span>
                   Title:<input
                            type="text"
                            name='title'
                            value={title}
